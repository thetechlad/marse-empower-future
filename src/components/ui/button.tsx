...
const buttonVariants = cva(
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-md text-sm font-medium ring-offset-background transition-all duration-300 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0",
  {
    variants: {
      variant: {
        default: "bg-primary text-primary-foreground hover:bg-primary-light shadow-card hover:shadow-elevated",
        destructive:
        ...
        hero: "bg-gradient-primary text-primary-foreground hover:shadow-hero transform hover:-translate-y-0.5 font-semibold",
        warm: "bg-gradient-warm text-accent-foreground hover:shadow-hero transform hover:-translate-y-0.5 font-semibold",
